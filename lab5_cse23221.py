# Lab5 A1-A7 — Full pipeline (Jupyter cell)
# Make sure required packages are installed: mne, numpy, pandas, sklearn, matplotlib
...
# ---------- USER SETTINGS ----------
# Update these two paths to point to your downloaded Sleep-EDF files.
# Example path structure (Windows):
# r"C:\Users\asus\Downloads\sleep-edf-database-expanded-1.0.0\sleep-cassette\SC4001E0-PSG.edf"
...
# For elbow we can't programmatically pick always — show inertia list
print("\nInertias (k=2..12):")
for k, val in zip(ks, inertias):
    print(f" k={k} -> inertia={val:.4e}")

# Optionally: If you want to save metric-plots or cluster labels to disk, you can do so here.
# End of Lab5 A1-A7 pipeline.